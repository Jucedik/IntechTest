...
import intech.juced.intechtest.activities.SongsActivityInterface;
import intech.juced.intechtest.adapters.AdapterControlsInterface;
...
public class SongsTableFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_songs_table, container, false);
            getViews();
            fillData();
        }
        return view;
    ...
    private void fillData() {
        songsAdapter = new SongsAdapter(realm, PlayerConfigs.SongsPresentationType.TABLE);
    ...
    private void getViews() {
        ...
        manager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                return songsAdapter.isFullWidth(position) ? manager.getSpanCount() : 1;
            }
        });
